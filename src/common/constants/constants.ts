export const GoogleProperties = [
    { text: "Web Search", property: "" },
    { text: "Image Search", property: "images" },
    { text: "News Search", property: "news" },
    { text: "Google Shopping", property: "froogle" },
    { text: "Youtube Search", property: "youtube" },
];

export const Categories = [
    { text: "All Categories", id: 0 },
    { text: "Arts & Entertainment", id: 3 },
    { text: "Autos & Vehicles", id: 47 },
    { text: "Beauty & Fitness", id: 44 },
    { text: "Books & Literature", id: 22 },
    { text: "Business & Industrial", id: 12 },
    { text: "Computers & Electonics", id: 5 },
    { text: "Finance", id: 7 },
    { text: "Food & Drink", id: 71 },
    { text: "Games", id: 8 },
    { text: "Health", id: 45 },
    { text: "Hobbies & Leisure", id: 65 },
    { text: "Home & Garden", id: 11 },
    { text: "Internet & Telecom", id: 13 },
    { text: "Jobs & Education", id: 958 },
    { text: "Law & Government", id: 19 },
    { text: "News", id: 16 },
    { text: "Online Communities", id: 299 },
    { text: "People & Society", id: 14 },
    { text: "Pets & Animals", id: 66 },
    { text: "Real Estate", id: 29 },
    { text: "Reference", id: 533 },
    { text: "Science", id: 174 },
    { text: "Shopping", id: 18 },
    { text: "Sports", id: 20 },
    { text: "Travel", id: 67 }
...
export const Countries = [
    { "code": "", "code3": "", "name": "Worldwide", "number": "" },
